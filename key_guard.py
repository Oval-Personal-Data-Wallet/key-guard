...
@click.option('-e', '--exempt', nargs=1, help='exempt a file from scanning by adding them to .guard/.fileignore')
@click.option('-inc', '--include', nargs=1, help='include a file to be scanned by removing from  .guard/.fileignore')
